 ...
 * inside the login modal. When `onSuccess` is provided (modal use) it fires
 * after a successful sign-in instead of navigating, so the modal can just
 * close and leave the user where they were.
 */
